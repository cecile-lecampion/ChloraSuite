# ChloraSuite - User Guide

## Overview

ChloraSuite is a Shiny application designed to analyze Chlorophyll fluorescence data. This tool allows you to process  files generated by fluorescence measurment tools and perform statistical analysis without requiring R programming knowledge.
...
Your .TXT files are tab-separated exports from your tool’s software and follow this layout:
...
For issues or questions about the ChloroSuite, please refer to the documentation or contact the development team at <a href="mailto:cecile.lecampion@univ-amu.fr">cecile.lecampion@univ-amu.fr</a>.
