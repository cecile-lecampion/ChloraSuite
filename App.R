# ChloraSuite: Fluorescence Data Analysis Toolbox - Main Application Entry Point
...
# It processes .TXT files generated by measurment tools 
...
# - .TXT files with systematic naming (VAR1_VAR2_VAR3.TXT)
...
# (AGPL-3.0). See the LICENSE file at the repository root for full terms.
...
#
# DATA PREPARATION:
# 1. Ensure files follow naming convention: VAR1_VAR2_VAR3.TXT
...
# Lecampion, C., & Field, B. (2025). ChloroSuite Data Analysis Toolbox. 
