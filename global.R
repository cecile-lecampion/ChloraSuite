...
# MEMORY MANAGEMENT
options(shiny.usecairo = FALSE)             # Disable Cairo for better compatibility

# CONCURRENT USER LIMITS (optional)
# options(shiny.maxworkers = 10)            # Limit concurrent sessions
