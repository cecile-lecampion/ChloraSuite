...
**ChloraSuite** is a comprehensive R Shiny web application designed to streamline the analysis of chlorophyll fluorescence data generated by various devices. The application provides a user-friendly interface for processing multiple `.TXT` files simultaneously, performing automated statistical analyses, and generating publication-ready visualizations without requiring programming knowledge.
...
# Contributing
Contributions to the ChloraSuite are welcome! If you have feature requests or suggestions, feel free to contact us at <a href="mailto:cecile.lecampion@univ-amu.fr">cecile.lecampion@univ-amu.fr</a> or open an issue on the GitHub repository.  
